...
function DashboardContent() {
  ...
  // UI State
  const [sidebarTab, _setSidebarTab] = useState<'overview' | 'tables' | 'bookings' | 'reports' | 'customers' | 'settings' | 'support' | 'qkhata' | 'payments' | 'messaging'>('overview');
  ...
  useEffect(() => {
    const handleHashChange = () => {
      ...
      const validTabs = ['overview', 'tables', 'bookings', 'reports', 'customers', 'settings', 'support', 'qkhata', 'payments', 'messaging'];
